...
package net.rationalminds.apache.http.client.entity;

import java.io.UnsupportedEncodingException;
import java.util.List;

import net.rationalminds.apache.http.annotation.NotThreadSafe;
import net.rationalminds.apache.http.client.utils.URLEncodedUtils;
import net.rationalminds.core.apache.http.NameValuePair;
import net.rationalminds.core.apache.http.entity.StringEntity;
