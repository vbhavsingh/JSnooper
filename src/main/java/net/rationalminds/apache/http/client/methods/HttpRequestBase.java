...
package net.rationalminds.apache.http.client.methods;
...
import net.rationalminds.apache.http.client.utils.CloneUtils;
import net.rationalminds.apache.http.conn.ClientConnectionRequest;
import net.rationalminds.apache.http.conn.ConnectionReleaseTrigger;
import net.rationalminds.core.apache.http.ProtocolVersion;
import net.rationalminds.core.apache.http.RequestLine;
import net.rationalminds.core.apache.http.message.AbstractHttpMessage;
import net.rationalminds.core.apache.http.message.BasicRequestLine;
import net.rationalminds.core.apache.http.message.HeaderGroup;
