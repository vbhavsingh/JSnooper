...
import net.rationalminds.apache.http.impl.conn.DefaultClientConnectionOperator;
 ...
 * </ul>
 *
 * @see com.e2e.apache.http.conn.params.ConnPerRoute 
 * @see com.e2e.apache.http.conn.params.ConnPerRouteBean
 *
 * @since 4.0
 */
public class ThreadSafeClientConnManager implements ClientConnectionManager {
    ...
    public ClientConnectionRequest requestConnection(
        ...
        return new ClientConnectionRequest() {
            ...
            public ManagedClientConnection getConnection(
                    ...
                    ConnectionPoolTimeoutException,IOException {
                if (route == null) {
    ...
    public void releaseConnection(ManagedClientConnection conn, long validDuration, TimeUnit timeUnit) throws IOException{
        ...
        synchronized (hca) {
            ...
            try {
               ...
               System.err.print("Exception shutting down released connection. "+
                              iox.getMessage());
            } finally {
    ...
    public void closeIdleConnections(long idleTimeout, TimeUnit tunit) throws IOException{
        connectionPool.closeIdleConnections(idleTimeout, tunit);
        connectionPool.deleteClosedConnections();
    }
    
    public void closeExpiredConnections() throws IOException{
