...
import net.rationalminds.apache.http.auth.params.AuthParams;
import net.rationalminds.core.apache.http.Header;
import net.rationalminds.core.apache.http.HttpRequest;
import net.rationalminds.core.apache.http.message.BasicHeaderValueFormatter;
...
import net.rationalminds.core.apache.http.util.EncodingUtils;
 ...
 * {@link com.e2e.apache.http.auth.params.AuthPNames#CREDENTIAL_CHARSET} 
...
public class DigestScheme extends RFC2617Scheme {
     ...
     * 
     * @throws com.e2e.apache.http.auth.InvalidCredentialsException if authentication credentials
