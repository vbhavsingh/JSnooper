...
import net.rationalminds.apache.http.auth.AuthScope;
...
import net.rationalminds.apache.http.client.NonRepeatableRequestException;
import net.rationalminds.apache.http.client.RedirectException;
import net.rationalminds.apache.http.client.RedirectHandler;
import net.rationalminds.apache.http.client.RequestDirector;
import net.rationalminds.apache.http.client.UserTokenHandler;
import net.rationalminds.apache.http.client.methods.AbortableHttpRequest;
...
import net.rationalminds.apache.http.conn.BasicManagedEntity;
...
import net.rationalminds.apache.http.conn.routing.BasicRouteDirector;
import net.rationalminds.apache.http.conn.routing.HttpRoute;
import net.rationalminds.apache.http.conn.routing.HttpRouteDirector;
...
import net.rationalminds.core.apache.http.entity.BufferedHttpEntity;
import net.rationalminds.core.apache.http.message.BasicHttpRequest;
...
import net.rationalminds.core.apache.http.protocol.HttpProcessor;
...
//            final UserTokenHandler userTokenHandler,
//            final HttpParams params) {
//        this(LogFactory.getLog(DefaultRequestDirector.class),requestExec,
//                conman,
//                reustrat,
//                kastrat,
//                rouplan,
