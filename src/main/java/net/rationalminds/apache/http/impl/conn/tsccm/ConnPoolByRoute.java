...
import net.rationalminds.apache.http.conn.params.ConnPerRoute;
...
public class ConnPoolByRoute extends AbstractConnPool {
    ...
    @Override
    public void freeEntry(BasicPoolEntry entry, boolean reusable, long validDuration, TimeUnit timeUnit) throws IOException{
     ...
     */
    protected BasicPoolEntry getFreeEntry(RouteSpecificPool rospl, Object state) throws IOException{
     ...
     */
    protected void deleteEntry(BasicPoolEntry entry) throws IOException{
     ...
     */
    protected void deleteLeastUsedEntry() throws IOException{
