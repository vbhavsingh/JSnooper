...
public interface ClientConnectionManager {
     ...
     */
    void releaseConnection(ManagedClientConnection conn, long validDuration, TimeUnit timeUnit) throws IOException;
     ...
     * @see #closeExpiredConnections()
     */
    void closeIdleConnections(long idletime, TimeUnit tunit) throws IOException;
     ...
     * Times will be checked with milliseconds precision.
     */
    void closeExpiredConnections() throws IOException;
