...
public class BasicHeaderValueFormatter implements HeaderValueFormatter {
     ...
     *
     * @param buffer       the name-value pair to format
     * @param param     <code>true</code> to always format with a quoted value,
     *                  <code>false</code> to use quotes only when necessary
     * @param b         the formatter to use, or <code>null</code>
     *                          for the {@link #DEFAULT default}
     *
