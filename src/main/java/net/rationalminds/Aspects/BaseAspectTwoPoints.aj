...
public abstract privileged aspect BaseAspectTwoPoints extends JSnooperAspectCore {
	...
	/**
	 * Operations after endPoint set end time for complete transaction. Do not
	 * recollect Data. Null data values possible.
	 */
